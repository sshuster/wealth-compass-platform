    ...
    <footer className="bg-card border-t border-border mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">WealthCompass</h3>
            <p className="text-muted-foreground">
              Your trusted platform for wealth management and investment planning.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/market" className="text-muted-foreground hover:text-primary transition-colors">Market Data</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {currentYear} WealthCompass. All rights reserved.
          </p>
